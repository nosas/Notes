...
```bash
nmap -sV -sC -oA nmap 10.10.10.165
```

### Output

```bash
root@beanbag:~/htb/boxes/traverxec$ less nmap.nmap
# Nmap 7.80 scan initiated Sat Mar 14 13:58:45 2020 as: nmap -sC -sV -oA nmap 10.10.10.165
...
# Nmap done at Sat Mar 14 13:59:02 2020 -- 1 IP address (1 host up) scanned in 17.03 seconds
```
